...
import ds.api.message.response.RegisterResponse;
import ds.api.Constant;
import ds.api.Credential;
import ds.api.message.Message;
import ds.api.message.request.RegisterRequest;
import ds.api.message.request.UnregisterRequest;
import ds.api.message.response.UnregisterResponse;
