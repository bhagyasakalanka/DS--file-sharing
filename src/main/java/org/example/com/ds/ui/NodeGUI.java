...
public class NodeGUI {
    ...
    private NodeOperationsWS nodeOpsWS;

    private int sequenceNo;

    public NodeGUI(NodeOperationsWS nodeOpsWS) {
        ...
        List<String> myFiles = nodeOpsWS.getNode().getNodeFileList();
        ...
        frame = new JFrame("Control Panel: " + nodeOpsWS.getNode().getCred().getNodeName() + "@" + nodeOpsWS.getNode().getCred().getNodeIP() + ":" + nodeOpsWS.getNode().getCred().getNodePort());
    ...
    private void addComponentsToPane(final Container containerPane) {
        ...
        btnSearch.addActionListener(new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                SearchReq searchRequest = new SearchReq(++sequenceNo, nodeOpsWS.getNode().getCred(), txtSearch.getText().trim(), 0);
                List<String> searchResult = nodeOpsWS.checkFilesInFileList(searchRequest.getFileName(), nodeOpsWS.getNode().getNodeFileList());
        ...
        btnDownload.addActionListener(new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Cred credential = new Cred("127.0.0.1", 40401, "hi there");
                DownloadReq downloadRequest = new DownloadReq(nodeOpsWS.getNode().getCred(), "Harry");
                if (credential.getNodePort() == 40401) {
                    System.out.println("File is locally available");
                } else {
                    System.out.println("xx");
